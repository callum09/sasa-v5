...
if ( $style == 'classic' ) {
   ...
   /* if($attachfile == 'true') {
    ...
    $output .= '<div class="mk-form-row">';
    $output .= '<div class="mk-form-half"><input placeholder="'.__( 'First Name*', 'mk_framework' ).'" type="text" required="required" name="contact_name" class="text-input" value="" tabindex="1" /></div>';
    $output .= '<div class="mk-form-half"><input placeholder="'.__( 'Last Name*', 'mk_framework' ).'" type="text" required="required" name="contact_last_name" class="text-input" value="" tabindex="2" /></div>';
    $output .= '</div>';
    $output .= '<div class="mk-form-row">';
    $output .= '<div class="'.(($phone == 'true')? 'mk-form-third' : 'mk-form-half').'"><input placeholder="'.__( 'Email*', 'mk_framework' ).'" type="email" required="required" name="contact_email" class="text-input" value="" tabindex="3" /></div>';
    $output .= '<div class="'.(($phone == 'true')? 'mk-form-third' : 'mk-form-half').'"><input placeholder="'.__( 'Website', 'mk_framework' ).'" type="text" required="required" name="contact_website" class="text-input" value="" tabindex="4" /></div>';
    if($phone == 'true') {
        $output .= '<div class="'.(($phone == 'true')? 'mk-form-third' : 'mk-form-half').'"><input placeholder="'.__( 'Your Phone Number', 'mk_framework' ).'" type="text" required="required" name="contact_phone" class="text-input two-third" value="" tabindex="5" /></div>';
    }
    $output .= '</div>';
    $output .= '<div class="mk-form-row"><div class="mk-form-full"><textarea required="required" placeholder="'.__( 'Message', 'mk_framework' ).'" name="contact_content" class="mk-textarea" tabindex="6"></textarea></div></div>';
   ...
   /* if($attachfile == 'true') {
    ...
    $output .= '<div class="mk-form-row">
                    <button tabindex="'.$tabindex_8.'" class="mk-progress-button mk-button contact-submit contact-form-button medium" data-style="move-up">
                        <span class="mk-progress-button-content">'.__( 'Send Message', 'mk_framework' ).'</span>
                        <span class="mk-progress">
                            <span class="mk-progress-inner"></span>
                        </span>
                        <span class="state-success"><i class="mk-moon-checkmark"></i></span>
